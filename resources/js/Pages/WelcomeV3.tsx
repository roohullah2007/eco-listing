                    ...
                    <div className="flex w-full items-center justify-between gap-12">
                        ...
                        <div style={{ maxWidth: '580px' }}>
                            <GlassCard className="mb-6 inline-flex items-center gap-2 rounded-full px-5 py-2.5" style={{ borderRadius: '9999px' }}>
                                <div className="h-2 w-2 rounded-full" style={{ backgroundColor: '#9AC6F9', boxShadow: '0 0 8px rgba(154, 198, 249, 0.6)' }} />
                            ...
                            <GlassCard className="mt-8" style={{ padding: '6px' }}>
                                ...
                                <div className="flex items-center rounded-xl bg-white shadow-lg" style={{ height: '52px' }}>
                                    <input
                                        ...
                                        style={{ fontSize: '15px', fontWeight: 400, color: '#000000' }}
                                    />
                                    <Link
                                        href="/map-search"
                                        className="flex items-center justify-center gap-2 rounded-r-xl bg-[#1D4AFA] text-white transition-colors hover:bg-[#1535C8]"
        ...
        <section style={{ backgroundColor: '#f9fafb' }}>
            <div className="mx-auto px-4 py-20" style={{ maxWidth: '1280px' }}>
                <div className="mb-4 text-center">
                    <span style={{ fontWeight: 600, fontSize: '13px', letterSpacing: '2px', color: '#7A7B7F' }}>HOW IT WORKS</span>
                </div>
                <h2 className="mb-14 text-center" style={{ fontWeight: 700, fontSize: '36px', lineHeight: '44px', color: '#000000' }}>
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-5">
                    {processSteps.map((item, index) => (
                        <GlassCardLight key={item.step} className="relative flex flex-col items-center p-6 text-center">
                            <div className="mb-4 flex items-center justify-center rounded-full" style={{ width: '48px', height: '48px', backgroundColor: '#1D4AFA' }}>
                                <span className="text-white" style={{ fontWeight: 700, fontSize: '14px' }}>{item.step}</span>
                            </div>
                            <h3 className="mb-2" style={{ fontWeight: 700, fontSize: '13px', color: '#000000', letterSpacing: '0.5px' }}>{item.title}</h3>
                            <p style={{ fontSize: '13px', lineHeight: '20px', color: '#7A7B7F' }}>{item.description}</p>
                        </GlassCardLight>
                    ))}
                </div>
            </div>
    ...
    return (
        <section className="relative overflow-hidden bg-white">
            ...
            <div className="relative mx-auto px-4 py-20" style={{ maxWidth: '1280px' }}>
                <div className="mb-4 text-center">
                    <span style={{ fontWeight: 600, fontSize: '13px', letterSpacing: '2px', color: '#7A7B7F' }}>THE ECOLISTING ADVANTAGE</span>
                </div>
                <h2 className="mb-3 text-center" style={{ fontWeight: 700, fontSize: '36px', lineHeight: '44px', color: '#000000' }}>
                    Why Sellers Choose EcoListing?
                </h2>
                <p className="mx-auto mb-14 text-center" style={{ fontSize: '16px', lineHeight: '24px', color: '#7A7B7F', maxWidth: '520px' }}>
                            ...
                            <GlassCardLight key={f.title} className="group flex flex-col p-7">
                                <div className="mb-5 flex items-center justify-center rounded-2xl border border-gray-200/60" style={{ width: '56px', height: '56px', background: 'rgba(245,245,244,0.8)', backdropFilter: 'blur(8px)' }}>
                                    <svg viewBox="0 0 24 24" fill="none" style={{ width: '28px', height: '28px' }}>
                                        <path d={f.icon} stroke="#9AC6F9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                </div>
                                <h3 className="mb-2" style={{ fontWeight: 700, fontSize: '18px', color: '#000000' }}>{f.title}</h3>
                                <p style={{ fontSize: '15px', lineHeight: '23px', color: '#7A7B7F' }}>{f.description}</p>
                            </GlassCardLight>
                        ))}
                    </div>
                        ...
                        <GlassCardLight className="flex h-full flex-col overflow-hidden" hover={false}>
                            <div className="flex flex-1 flex-col justify-between p-8">
                                <div className="mb-2 flex items-center justify-between">
                                    <span style={{ fontWeight: 600, fontSize: '13px', color: '#7A7B7F', letterSpacing: '1px', textTransform: 'uppercase' }}>Listing Price</span>
                                    <span style={{ fontWeight: 700, fontSize: '34px', color: '#000000' }}>${listingPrice.toLocaleString()}</span>
                                </div>
                                <input type="range" min={200000} max={2000000} step={10000} value={listingPrice} onChange={(e) => setListingPrice(Number(e.target.value))} className="mt-4 mb-2 w-full accent-blue-500" style={{ height: '6px' }} />
                                ...
                                <div className="rounded-xl p-5" style={{ background: 'rgba(249,250,251,0.8)', backdropFilter: 'blur(8px)' }}>
                                    <div className="flex items-center justify-between pb-4" style={{ borderBottom: '1px solid rgba(229,229,229,0.6)' }}>
                                        <span style={{ fontSize: '15px', color: '#7A7B7F' }}>Traditional Fee (2.5%)</span>
                                    ...
                                    <div className="flex items-center justify-between pt-4">
                                        <div className="flex items-center gap-2">
                                            <svg viewBox="0 0 20 20" fill="#1D4AFA" style={{ width: '18px', height: '18px' }}><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clipRule="evenodd" /></svg>
                                            <span style={{ fontWeight: 600, fontSize: '15px', color: '#1D4AFA' }}>EcoListing Fee (1%)</span>
                                        </div>
                                        <span style={{ fontWeight: 700, fontSize: '16px', color: '#1D4AFA' }}>${ecoFee.toLocaleString()}</span>
                                    </div>
                                </div>

                                <div className="mt-5 overflow-hidden rounded-xl" style={{ border: '2px solid #1D4AFA' }}>
                                    <div className="py-2" style={{ backgroundColor: '#1D4AFA' }}>
                                    ...
                                    <div className="py-5 text-center" style={{ background: 'rgba(255,255,255,0.9)', backdropFilter: 'blur(8px)' }}>
                                        <p style={{ fontWeight: 800, fontSize: '44px', lineHeight: '52px', color: '#1D4AFA' }}>${savings.toLocaleString()}</p>
                                    </div>
                                </div>
                            </div>

                            <div className="flex justify-center pb-7">
                                <a href="#" className="flex items-center justify-center rounded-full transition-colors hover:bg-[#1535C8]" style={{ width: '220px', height: '48px', backgroundColor: '#1D4AFA', fontWeight: 600, fontSize: '14px', color: '#fff', letterSpacing: '0.5px' }}>
                                    SEE FULL BREAKDOWN
                                </a>
                            </div>
                        </GlassCardLight>
...
function MarketingToolsSection() {
    ...
    return (
        <section style={{ backgroundColor: '#f9fafb' }}>
            <div className="mx-auto px-4 py-20" style={{ maxWidth: '1280px' }}>
                <div className="mb-4 text-center">
                    <span style={{ fontWeight: 600, fontSize: '13px', letterSpacing: '2px', color: '#7A7B7F' }}>MARKETING SUITE</span>
                </div>
                <h2 className="mb-3 text-center" style={{ fontWeight: 700, fontSize: '36px', lineHeight: '44px', color: '#000000' }}>
                    Industry-Leading Marketing Tools
                    <br />to Reach More Buyers
                </h2>
                <p className="mx-auto mb-16 text-center" style={{ fontSize: '16px', lineHeight: '24px', color: '#7A7B7F', maxWidth: '480px' }}>
                    ...
                    <div className="flex flex-1 flex-col gap-5">
                        {marketingFeatures.map((f, idx) => (
                            <div key={f.title} onMouseEnter={() => setActiveIdx(idx)}>
                                <GlassCardLight className={`group flex cursor-pointer items-start gap-5 p-6 ${activeIdx === idx ? '!border-[#1D4AFA]/30 !shadow-lg' : ''}`}>
                                    <div className="flex shrink-0 items-center justify-center rounded-2xl border border-gray-200/60 transition-transform group-hover:scale-105" style={{ width: '56px', height: '56px', background: activeIdx === idx ? 'rgba(29,74,250,0.06)' : 'rgba(245,245,244,0.8)', backdropFilter: 'blur(8px)' }}>
                                        <svg viewBox="0 0 24 24" fill="none" style={{ width: '28px', height: '28px' }}><path d={f.icon} stroke="#9AC6F9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
                                    </div>
                                    <div>
                                        <h3 className="mb-1" style={{ fontWeight: 700, fontSize: '18px', color: '#000000' }}>{f.title}</h3>
                                        <p style={{ fontSize: '15px', lineHeight: '23px', color: '#7A7B7F' }}>{f.description}</p>
                                    </div>
                                </GlassCardLight>
                            </div>
                            ...
                            <div className="relative flex-1" style={{ minHeight: '320px', background: 'linear-gradient(135deg, rgba(245,245,244,0.9), rgba(255,255,255,0.6))' }}>
                                <div className="absolute inset-0 flex flex-col items-center justify-center transition-opacity duration-300">
                                    <svg viewBox="0 0 24 24" fill="none" style={{ width: '64px', height: '64px', marginBottom: '16px' }}>
                                        <path d={active.previewIcon} stroke="#9AC6F9" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" opacity="0.3" />
                                    </svg>
                                    <p style={{ fontWeight: 700, fontSize: '18px', color: '#000000' }}>{active.previewTitle}</p>
                                    <p style={{ fontSize: '14px', color: '#7A7B7F', marginTop: '4px' }}>{active.previewSub}</p>
                                </div>
                                <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: 'linear-gradient(rgba(154,198,249,0.3) 1px, transparent 1px), linear-gradient(90deg, rgba(154,198,249,0.3) 1px, transparent 1px)', backgroundSize: '40px 40px' }} />
                            </div>
                            <div className="flex items-center justify-between border-t border-gray-200/60 px-6 py-4">
                                <div>
                                    <p style={{ fontWeight: 700, fontSize: '15px', color: '#000000' }}>{active.previewTitle}</p>
                                    <p style={{ fontSize: '13px', color: '#7A7B7F' }}>Interactive Preview</p>
                                </div>
                                <a href="#" className="flex items-center justify-center rounded-full transition-colors hover:bg-[#1535C8]" style={{ width: '140px', height: '42px', backgroundColor: '#1D4AFA', fontWeight: 600, fontSize: '13px', color: '#fff' }}>
                                    Explore Tour
                                </a>
                            </div>
                        </GlassCardLight>
            ...
            <div className="mx-auto px-4 py-20" style={{ maxWidth: '1280px' }}>
                <div className="flex items-start gap-16">
                    <div className="shrink-0" style={{ maxWidth: '380px' }}>
                        <span style={{ fontWeight: 600, fontSize: '13px', letterSpacing: '2px', color: '#7A7B7F' }}>VIRTUAL EXPERIENCE</span>
                        <h2 className="mt-3" style={{ fontWeight: 700, fontSize: '42px', lineHeight: '50px', color: '#000000' }}>
                            ...
                            {showcaseFeatures.map((f) => (
                                <div key={f.title} className="flex items-start gap-4">
                                    <GlassCardLight className="flex shrink-0 items-center justify-center" style={{ width: '48px', height: '48px' }} hover={false}>
                                        <svg viewBox="0 0 24 24" fill="none" style={{ width: '24px', height: '24px' }}><path d={f.icon} stroke="#9AC6F9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
                                    </GlassCardLight>
                                    <div>
                                        <h3 style={{ fontWeight: 700, fontSize: '16px', color: '#000000' }}>{f.title}</h3>
                                        <p style={{ fontSize: '14px', lineHeight: '20px', color: '#7A7B7F' }}>{f.description}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
                        ...
                        <div className="group relative overflow-hidden rounded-2xl shadow-lg" style={{ aspectRatio: '16/9', border: '1px solid rgba(0,0,0,0.06)' }}>
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="flex items-center justify-center rounded-full shadow-lg transition-transform group-hover:scale-110" style={{ width: '80px', height: '80px', background: 'rgba(255,255,255,0.85)', backdropFilter: 'blur(12px)' }}>
                                    <svg viewBox="0 0 24 24" fill="#9AC6F9" style={{ width: '32px', height: '32px', marginLeft: '3px' }}>
...
function TestimonialsSection() {
    return (
        <section style={{ backgroundColor: '#f9fafb' }}>
            <div className="mx-auto px-4 py-20" style={{ maxWidth: '1280px' }}>
                <div className="mb-4 text-center">
                    <span style={{ fontWeight: 600, fontSize: '13px', letterSpacing: '2px', color: '#7A7B7F' }}>TESTIMONIALS</span>
                </div>
                <h2 className="mb-3 text-center" style={{ fontWeight: 700, fontSize: '36px', lineHeight: '44px', color: '#000000' }}>
                    What clients have experienced?
                </h2>
                <p className="mx-auto mb-14 text-center" style={{ fontSize: '16px', lineHeight: '24px', color: '#7A7B7F', maxWidth: '580px' }}>
                        ...
                        <GlassCardLight key={t.initials} className="flex flex-col justify-between p-8">
                            <div>
                                <svg viewBox="0 0 24 24" fill="none" style={{ width: '32px', height: '32px', marginBottom: '16px' }}>
                                    <path d="M7.5 8.25h-3a1.5 1.5 0 00-1.5 1.5v3a1.5 1.5 0 001.5 1.5h1.5a1.5 1.5 0 011.5 1.5v.75a3 3 0 01-3 3H3.75M16.5 8.25h-3a1.5 1.5 0 00-1.5 1.5v3a1.5 1.5 0 001.5 1.5h1.5a1.5 1.5 0 011.5 1.5v.75a3 3 0 01-3 3h-.75" stroke="#9AC6F9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" opacity="0.3" />
                                </svg>
                                <p style={{ fontSize: '15px', lineHeight: '24px', color: 'rgb(60,60,60)' }}>"{t.quote}"</p>
                            </div>
                            <div className="mt-8 flex items-center gap-4">
                                <div className="flex shrink-0 items-center justify-center rounded-full" style={{ width: '48px', height: '48px', backgroundColor: '#1D4AFA' }}>
                                    <span style={{ fontWeight: 700, fontSize: '14px', color: '#fff' }}>{t.initials}</span>
                                </div>
                                <div>
                                    <p style={{ fontWeight: 700, fontSize: '15px', color: '#000000' }}>{t.name}</p>
                                    <p style={{ fontSize: '13px', color: '#7A7B7F' }}>{t.role}</p>
                                </div>
                            </div>
                        </GlassCardLight>
                    ))}
        ...
        <section className="bg-white">
            <div className="mx-auto px-4 py-20" style={{ maxWidth: '1280px' }}>
                <div className="flex items-center gap-16">
                    <div className="flex-1">
                        <span style={{ fontWeight: 600, fontSize: '13px', letterSpacing: '2px', color: '#7A7B7F' }}>FREE CMA REPORT</span>
                        <h2 className="mt-3" style={{ fontWeight: 700, fontSize: '36px', lineHeight: '44px', color: '#000000' }}>
                            Discover Your Home's<br />True Market Value
                        </h2>
                        <p className="mt-4" style={{ fontSize: '16px', lineHeight: '24px', color: '#7A7B7F', maxWidth: '460px' }}>
                            Get an accurate estimate by expert agent using latest market data and comparable sales across British Columbia.
                        </p>
                        <a href="#" className="mt-5 inline-block underline" style={{ fontWeight: 600, fontSize: '14px', color: '#1D4AFA' }}>See sample CMA report</a>

                        <GlassCardLight className="mt-8 flex items-center overflow-hidden" style={{ maxWidth: '460px', height: '52px' }} hover={false}>
                            <input type="text" placeholder="Enter property address in BC" className="h-full flex-1 border-0 bg-transparent pl-5 pr-2 focus:ring-0" style={{ fontSize: '15px', color: '#000000' }} />
                            <button className="mr-1 flex items-center justify-center gap-2 rounded-full text-white transition-colors hover:bg-[#1535C8]" style={{ width: '180px', height: '44px', backgroundColor: '#1D4AFA', fontSize: '14px', fontWeight: 600 }}>
                        ...
                        <div className="mt-6 flex items-center gap-6">
                            {['Licensed REALTOR\u00AE', '100% Free Market Analysis', 'No sign-up required'].map((text) => (
                                <div key={text} className="flex items-center gap-2">
                                    <svg viewBox="0 0 20 20" fill="#1D4AFA" style={{ width: '16px', height: '16px' }}><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clipRule="evenodd" /></svg>
                                    <span style={{ fontWeight: 500, fontSize: '13px', color: '#7A7B7F' }}>{text}</span>
                                </div>
                            ))}
                        </div>
                    </div>
...
// ─── Main Page ──────────────────────────────────────────
export default function WelcomeV3({ featuredListings = [] }: { featuredListings?: FeaturedListing[] }) {
    return (
        <>
